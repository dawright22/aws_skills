...
argument-hint: "Auth flow, token type, or feature to look up (e.g. 'user pool app client', 'OAuth authorization code flow', 'JWKS token validation', 'identity pool AWS credentials')"
user-invocable: true

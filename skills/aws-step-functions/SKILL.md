...
argument-hint: "Workflow pattern, state type, or issue to look up (e.g. 'parallel state', 'map state iteration', 'error handling with retry/catch', 'Express vs Standard workflow')"
user-invocable: true

...
argument-hint: "Secret type, rotation configuration, or access pattern to look up (e.g. 'RDS secret rotation', 'caching secrets in Lambda', 'resource policy', 'cross-account access')"
user-invocable: true

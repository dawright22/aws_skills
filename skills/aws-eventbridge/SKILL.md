...
argument-hint: "Event source, pattern type, or scheduling scenario to look up (e.g. 'custom event bus rule', 'S3 event pattern', 'scheduled rate expression', 'cross-account event routing')"
user-invocable: true

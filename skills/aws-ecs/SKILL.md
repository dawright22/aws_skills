...
argument-hint: "Container workload type, issue, or configuration to look up (e.g. 'Fargate task definition', 'service with load balancer', 'container keeps restarting')"
user-invocable: true
